...
% The method uses one neutron-photon coupled simulation using the MCNP PIKMT card to evaluate the energy deposited by prompt gamma radiation originating at fuel fission events.
...
% So, several of the gammas originating here will not be deposited in the experiment position but in the fuel elements.
% Additionally, our method considers that the gamma originate uniformly across the cell geometry.
...
\bibliography{revised_bibliography}
